...
<div class="content-center items-center">
	<div
		class="navbar bg-base-100 w-4/5 fixed top-5 mx-auto inset-x-0 drop-shadow-md rounded-md">
...
<!-- Section 5 -->
<section id="services" class="hero min-h-screen bg-sky-100">
	<div class="hero-content text-center">
		<div class="container text-start">
			<div class="grid grid-cols-1">
				<h2 class="text-2xl font-bold text-gray-800 mb-4">Services:</h2>
				<p class="text-lg text-gray-700">
					IgniteHub offers a variety of IT services, including web
					design, management & hosting, marketing...
				</p>
			</div>
		</div>
	</div>
