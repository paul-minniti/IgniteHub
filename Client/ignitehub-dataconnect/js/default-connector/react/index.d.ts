import { ListNewsletterSignIpsData, GetNewsletterByEmailData, GetNewsletterByEmailVariables, ListUsersData, ListOrgsData, GetUserByIdData, GetUserByIdVariables, GetUserOrgData, GetUserOrgVariables, GetWebsitesInOrgData, GetWebsitesInOrgVariables, CreateUserData, CreateUserVariables, AddNewsletterSignUpData, AddNewsletterSignUpVariables, CreateOrgData, CreateOrgVariables, AddUserToOrgData, AddUserToOrgVariables } from '../';
...
export function useGetUserOrg(vars: GetUserOrgVariables, options?: useDataConnectQueryOptions<GetUserOrgData>): UseQueryResult<FlattenedQueryResult<GetUserOrgData, GetUserOrgVariables>, FirebaseError>;
export function useGetUserOrg(dc: DataConnect, vars: GetUserOrgVariables, options?: useDataConnectQueryOptions<GetUserOrgData>): UseQueryResult<FlattenedQueryResult<GetUserOrgData, GetUserOrgVariables>, FirebaseError>;
